...
The environment can be created for every repo and is available as a `Codespaces` tab under the green button `Code`. The environment, once built, looks like in the figure below:

![Codespaces](github_codespaces.png)

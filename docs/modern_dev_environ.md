...
* Add [continuous integration by GitHub Actions](https://docs.github.com/en/actions/automating-builds-and-tests)
...
Note: the branches `template/java` and `template/python` show minimal projects in Java and Python. The Java project requires matching the right versions of JDK and Gradle.

## More

* [UK gov cookiecutter simplifies development and improves](https://dataingovernment.blog.gov.uk/2021/07/20/govcookiecutter-a-template-for-data-science-projects/)